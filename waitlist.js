(function () {
  ...
  var T = {
    it: {
      ...
      subtitle: 'Sii tra i primi ad accedere a Fashion AI. Ti avviseremo non appena sarà disponibile.',
      name_ph: 'Il tuo nome (opzionale)',
      email_ph: 'La tua email *',
      submit: 'Unisciti alla lista',
      success_title: 'Sei nella lista!',
      success_msg: 'Ti contatteremo non appena Fashion AI sarà disponibile.',
      err_email: 'Inserisci un indirizzo email valido.',
      err_generic: 'Qualcosa è andato storto. Riprova.',
    },
    en: {
      title: 'Join the waitlist',
      subtitle: 'Be among the first to access Fashion AI. We\'ll notify you as soon as it\'s available.',
      name_ph: 'Your name (optional)',
      email_ph: 'Your email *',
      submit: 'Join the waitlist',
      success_title: 'You\'re on the list!',
      success_msg: 'We\'ll reach out as soon as Fashion AI is available.',
      err_email: 'Please enter a valid email address.',
      err_generic: 'Something went wrong. Please try again.',
    },
    es: {
      title: 'Únete a la lista de espera',
      subtitle: 'Sé de los primeros en acceder a Fashion AI. Te avisaremos en cuanto esté disponible.',
      name_ph: 'Tu nombre (opcional)',
      email_ph: 'Tu email *',
      submit: 'Unirme a la lista',
      success_title: '¡Ya estás en la lista!',
      success_msg: 'Te contactaremos en cuanto Fashion AI esté disponible.',
